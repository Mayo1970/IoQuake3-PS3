...
{
	{
		// PS3: 640x480, fullscreen, max texture quality (picmip 0),
		// lightmap lighting, default texturebits, medium geometry,
		// trilinear filter, default driver, extensions on
		3, qtrue, 3, 0, 0, 1, 1, 0, qtrue
	}
};
