...
*/
#ifdef USE_RENDERER_DLOPEN
Q_EXPORT refexport_t* QDECL tr_init_GetRefAPI_unused ( int apiVersion, refimport_t *rimp ) {
#else
refexport_t *tr_init_GetRefAPI_unused ( int apiVersion, refimport_t *rimp ) {
#endif
